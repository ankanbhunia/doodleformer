...
def calculate_scores_given_paths(paths, batch_size, cuda, dims, name, src_pkl_file):
    ...
    if os.path.isfile(src_pkl_file):

        with open(src_pkl_file, "rb") as fp:   #Pickling

            m1, s1, d1, CS1, SDS1 = pickle.load(fp)
        ...
        with open(src_pkl_file, "wb") as fp:   #Pickling

            pickle.dump([m1, s1, d1, CS1, SDS1], fp)                                   
...
if __name__ == '__main__':
    print(calculate_scores_given_paths(['../../data/bird_short_full_nodetail_64','../../output/G_195/'], 50, 1, 2048, 'birds', src_pkl_file='birds.pickle'))
