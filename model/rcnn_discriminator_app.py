...
class ResnetDiscriminator128_app(nn.Module):
    ...
    def forward(self, x, y=None, bbox=None, idx = None):
        ...
        #obj_feat_zeros = torch.zeros((32*(self.num_classes-1), 1024)).to(obj_feat.device)
        #y_zeros = torch.zeros((32*(self.num_classes-1))).to(y.device)
        ...
        #obj_feat_2 = obj_feat_zeros.view(32, (self.num_classes-1), -1)

        #y_2 = y_zeros.view(32, (self.num_classes-1))
...
class CombineDiscriminator128_app(nn.Module):
    ...
    def forward(self, images, bbox, label, mask=None):
        ...
        # print(bbox.shape)
        # print(label.shape)
        d_out_img, d_out_obj, out_app = self.obD(images, label, bbox, idx = idx)
